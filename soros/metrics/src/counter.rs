...
impl Counter {
    fn default_log_rate() -> usize {
        let v = env::var("BITCONCH_DEFAULT_LOG_RATE")
...
mod tests {
    ...
    fn test_lograte() {
        ...
        assert_eq!(
            ...
            DEFAULT_LOG_RATE,
            "default_log_rate() is {}, expected {}, BITCONCH_DEFAULT_LOG_RATE environment variable set?",
            Counter::default_log_rate(),
            DEFAULT_LOG_RATE,
        );
    ...
    fn test_lograte_env() {
        ...
        env::set_var("BITCONCH_DEFAULT_LOG_RATE", "50");
        inc_counter!(COUNTER, Level::Info, 2);
        unsafe {
        ...
        env::set_var("BITCONCH_DEFAULT_LOG_RATE", "0");
