use bitconch_native_loader;
use bitconch_sdk::account::{create_keyed_accounts, Account, KeyedAccount};
...
fn process_instruction(
    ...
    if system_program::check_id(&program_id) {
        bitconch_system_program::entrypoint(
            &program_id,
        ...
        bitconch_native_loader::entrypoint(
            &program_id,
            &mut keyed_accounts,
            &tx.instructions[instruction_index].userdata,
            tick_height,
