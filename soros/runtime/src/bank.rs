...
impl Bank {
    ...
    fn add_builtin_programs(&self) {
        self.add_native_program("bitconch_system_program", &system_program::id());
        self.add_native_program("bitconch_vote_program", &vote_program::id());
        self.add_native_program("bitconch_storage_program", &storage_program::id());
        self.add_native_program("bitconch_bpf_loader", &bpf_loader::id());
        self.add_native_program("bitconch_budget_program", &budget_program::id());
        self.add_native_program("bitconch_erc20", &token_program::id());
    }
...
mod tests {
    ...
    use bitconch_sdk::genesis_block::BOOTSTRAP_LEADER_TOKENS;
    use bitconch_sdk::native_program::ProgramError;
