...
use soros_sdk::hash::{extend_and_hash, Hash};
...
use soros_sdk::timing::{duration_as_us, MAX_RECENT_BLOCKHASHES, NUM_TICKS_PER_SECOND};
use soros_sdk::transaction::Transaction;
use soros_vote_api::vote_instruction::Vote;
use soros_vote_api::vote_state::{Lockout, VoteState};
use std::result;
...
impl Bank {
    ...
    fn add_builtin_programs(&self) {
        self.add_native_program("soros_system_program", &system_program::id());
        self.add_native_program("soros_vote_program", &soros_vote_api::id());
        self.add_native_program("soros_storage_program", &soros_storage_api::id());
        self.add_native_program("soros_bpf_loader", &bpf_loader::id());
        self.add_native_program("soros_budget_program", &soros_budget_api::id());
        self.add_native_program("soros_token_program", &soros_token_api::id());
    }
...
mod tests {
    ...
    use soros_sdk::system_transaction::SystemTransaction;
    use soros_sdk::transaction::Instruction;
