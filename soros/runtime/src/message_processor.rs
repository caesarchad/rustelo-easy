...
use soros_sdk::instruction::{CompiledInstruction, InstructionError};
use soros_sdk::instruction_processor_utils;
...
fn verify_instruction(
    ...
    if *program_id != account.owner && pre_dif > account.dif {
