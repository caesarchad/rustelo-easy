use soros_rewards_api::rewards_transaction::RewardsTransaction;
...
use soros_vote_api::vote_state::{self, VoteState};
...
impl<'a> RewardsBank<'a> {
    fn new(bank: &'a Bank) -> Self {
        bank.add_native_program("soros_rewards_program", &soros_rewards_api::id());
        Self { bank }
    }
