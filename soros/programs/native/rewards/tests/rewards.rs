use bitconch_rewards_api::rewards_program;
use bitconch_rewards_api::rewards_transaction::RewardsTransaction;
use bitconch_runtime::{execute_transaction, RuntimeError};
use bitconch_sdk::account::Account;
use bitconch_sdk::hash::Hash;
use bitconch_sdk::native_loader::create_program_account;
...
fn create_rewards_account(
    ...
    let system_program_account = create_program_account("bitconch_system_program");
...
fn create_vote_account(
    ...
    let system_program_account = create_program_account("bitconch_system_program");
    let vote_program_account = create_program_account("bitconch_vote_program");
    let loaders = &mut [
...
fn redeem_credits(
    ...
    let last_id = Hash::default();
    let rewards_program_account = create_program_account("bitconch_rewards_program");
    let vote_program_account = create_program_account("bitconch_vote_program");
    let loaders = &mut [
