...
1. Push the new branch to the soros repository
...
1. If the first major release on the branch (e.g. v0.8.0), paste in [this
   template](https://raw.githubusercontent.com/bitconch/soros/master/.github/RELEASE_TEMPLATE.md)
   and fill it in.
...
1. Verify release automation:
   1. [Crates.io](https://crates.io/crates/soros) should have an updated Bitconch version.
   1. ...
1. After testnet deployment, verify that testnets are running correct software.
   http://dashboard.bitconch.io should show testnet running on a hash from your
