...
use bitconch_sdk::timing::{duration_as_ms, timestamp};
...
impl Fullnode {
    pub fn new(
        ...
        //       See https://github.com/bitconch/bus/issues/1830 for the removal of drone
        //       from the RPC API
        let drone_addr = {
            ...
            entrypoint_drone_addr.set_port(bitconch_drone::drone::DRONE_PORT);
