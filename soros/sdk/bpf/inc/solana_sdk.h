#pragma once
/**
 * @brief Soros C-based BPF program utility functions and types
 */
...
typedef struct {
  ...
  uint64_t *dif;      /** Number of dif owned by this account */
 ...
 * that any modification to dif or account data take place on the original
