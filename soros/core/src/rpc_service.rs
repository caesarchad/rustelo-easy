//! The `rpc_service` module implements the Bitconch JSON RPC service.
...
mod tests {
    ...
    fn test_rpc_new() {
        ...
        let rpc_addr = SocketAddr::new(
            ...
            soros_netutil::find_available_port_in_range((10000, 65535)).unwrap(),
        );
        ...
        assert_eq!(thread.name().unwrap(), "soros-jsonrpc");
